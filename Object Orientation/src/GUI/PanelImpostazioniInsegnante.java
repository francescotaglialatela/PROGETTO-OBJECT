...
public class PanelImpostazioniInsegnante extends JPanel {
	 ...
	 * Create the panel.
	 */
	public PanelImpostazioniInsegnante(String user, Account_Insegnante frame) {
		...
		ArrayList<String> datiInsegnante;
		
		datiInsegnante = controller.datiInsegnanteDB(username);
		...
		nomeField.setText(datiInsegnante.get(0));
		...
		cognomeField.setText(datiInsegnante.get(1));
		...
		emailField.setText(datiInsegnante.get(2));
		...
		usernameField.setText(datiInsegnante.get(3));
		...
		sfondoUser.setIcon(new ImageIcon(PanelImpostazioni.class.getResource("/res/user (10).png")));
		...
		btnModificaPassword.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ModificaAccountInsegnante Modifica = new ModificaAccountInsegnante(username);
		...
		passwordField.setText(datiInsegnante.get(4));
